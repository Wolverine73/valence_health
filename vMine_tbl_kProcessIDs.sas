/*HEADER------------------------------------------------------------------------
|
| program:  vmine_tbl_kProcessIDs.sas
|
| location: M:\CI\programs\StandardMacros
|
| purpose:  Return distinct kProcessIDs from all PM System tables from CIMaster
|
| logic:    
|
| input:  SQL tables       
...
| history:  
|
| 10AUG2011 - Winnie Lee - Clinical Integration 1.0.01
|
|
+-----------------------------------------------------------------------HEADER*/

%macro vMine_tbl_kprocessIDs (); 
