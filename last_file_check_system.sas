...
/*HEADER------------------------------------------------------------------------
|
| program:  last_file_check_system.sas
|
...
%macro last_file_check_system(client=, client_id=, system=, systemid=);
	...
	where clientid = &client_id. and systemid=&systemid. and system="&system.";
/*	var client system practiceid practice_name file_name file_month installstat;*/
