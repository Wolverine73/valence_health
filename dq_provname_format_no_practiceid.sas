...
class raw_lname raw_fname raw_npi provname_up provname;
...
------------------------------------------------------------------------SASDOC*;
proc sql;
CREATE TABLE dq_provnamecheck AS SELECT m.raw_lname, m.raw_fname, m.raw_npi, m._provname, 
...
proc sql;
CREATE TABLE dq_provnpicheck AS SELECT 	m.raw_lname, m.raw_fname, m.raw_npi, m.provname_up, m._provname,
