/*HEADER------------------------------------------------------------------------
|
| program:  vmine_pmsystem_72
|
| location: M:\CI\programs\StandardMacros
|
| purpose:  Perform cleansing rules on the MPMOffice system practice data   
|
| logic:                   
|
| input:         
