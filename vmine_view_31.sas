/*HEADER------------------------------------------------------------------------
|
| program:  vmine_view_31
|
| location: M:\CI\programs\StandardMacros
|
| purpose:  Create practice data from ASPC vmine view  
|
| logic:                   
|
| input:         
...
/*			(	*/
/*				exec dbo.spASPC &do_practice_id., &maxprocessid.*/
/*			)*/
/*		;*/
/*	quit;*/
	...
	proc sql;
		connect to oledb(init_string=&emine.);
			create table practice_&do_practice_id. as select * from connection to oledb
			(	
				exec dbo.sp_ASPC_Claims &do_practice_id., &maxprocessid.
			)
		;
	quit;
