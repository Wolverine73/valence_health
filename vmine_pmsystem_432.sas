/*HEADER------------------------------------------------------------------------
|
| program:  vmine_pmsystem_432
|
| location: M:\CI\programs\StandardMacros
|
| purpose:  Perform cleansing rules on the DELPHI system practice data   
|
| logic:                   
|
| input:         
...
+-----------------------------------------------------------------------HEADER*/
 ...
 %macro vmine_pmsystem_432;
	...
	------------------------------------------------------------------------SASDOC*;
	lname    = tranwrd(lname, '*', '');
	if payorname1='_' then payorname1="";
