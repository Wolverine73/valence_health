...
/*HEADER------------------------------------------------------------------------
|
| program:  vmine_view_3
|
| location: M:\CI\programs\StandardMacros
|
| purpose:  Create practice data from centricity vmine view  
|
| logic:                   
|
| input:         
...
/*	quit;*/
	...
	proc sql;
		...
		create table practice_&do_practice_id. as select * from connection to oledb
		(	
			exec dbo.sp_Centricity_Claims &do_practice_id., &maxprocessid.
		);
	quit;
