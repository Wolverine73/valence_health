...
/*HEADER------------------------------------------------------------------------
|
| program:  vmine_view_5
|
| location: M:\CI\programs\StandardMacros
|
| purpose:  Create practice data from MedicalManager vmine view  
|
| logic:                   
|
| input:         
...
/*	  (	*/
/*		select *	               */
/*		from    dbo.tstMedicalManagerView*/
...
/*		(*/
/*			exec dbo.spMedicalManager &do_practice_id., &maxprocessid.*/
/*		);*/
/*	quit;*/
/**/
/*	proc sql;*/
...
/*	quit;*/
	...
	proc sql;
		...
		create table practice_&do_practice_id. as select * from connection to oledb
		(
			exec dbo.sp_MedicalManager_Claims &do_practice_id., &maxprocessid.
		);
	quit;
