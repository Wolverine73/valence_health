...
/*HEADER------------------------------------------------------------------------
|
| program:  edw_guideline_master_guidelines.sas
|
...
| 08MAY2012 - LS modify to only run guidelines - split guideline master into 3.
+-----------------------------------------------------------------------HEADER*/
...
%mvarexist(SAS_MODE); 
	%if &mvarexist. %then %do;
		%if %upcase(&sas_mode)=TEST %then %do;  	
 				libname release "M:\CI\sasdata\ValenceBaseMeasures\Guideline Development\CCCPP\Registry\Testing";
				libname registry "M:\CI\sasdata\ValenceBaseMeasures\Guideline Development\CCCPP\Registry\Testing";
...
%put *********************************************;
%put NOTE: ***************************************;
%put NOTE: Today is a guideline run day ;
%put NOTE: ***************************************;
%put *********************************************;
...
/* FOR DEVELOPMENT/TESTING RUNS: */
/*libname current1 "M:\sastemp\CIStaging\GD TESTING\current";*/
/*libname prior1 "M:\sastemp\CIStaging\GD TESTING\prior";*/
/*libname out_det "M:\sastemp\CIStaging\GD TESTING";*/
/**/
/*%let current1 = M:\sastemp\CIStaging\GD TESTING\current;*/
/*%let prior1 = M:\sastemp\CIStaging\GD TESTING\prior;*/
/*%let out_det = M:\sastemp\CIStaging\GD TESTING;*/
