...
%macro edw_linking_cleaner_phone(prefix);

&prefix.phone = compbl(compress(&prefix.phone,"`~!@#$%^&*()-_+=\|][{}',.<>?/:;"));
if length(&prefix.phone) ne 10 or substr(&prefix.phone,4,1) in ("0","1") or 
substr(&prefix.phone,1,3) not in (
...
"975","978","979","980","984","985","989"
	...
	or substr(&prefix.phone,4,3) = "555" then &prefix.phone = "";

%mend edw_linking_cleaner_phone;
