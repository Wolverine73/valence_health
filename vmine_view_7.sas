...
/*HEADER------------------------------------------------------------------------
|
| program:  vmine_view_7
|
| location: M:\CI\programs\StandardMacros
|
| purpose:  Create practice data from app med vmine view  
|
| logic:                   
|
| input:         
...
/*	quit;*/
	...
	proc sql;
		...
		create table practice_&do_practice_id. as select * from connection to oledb
		(	
			exec dbo.sp_AppMed_Claims &do_practice_id., &maxprocessid.
		);
	quit;
