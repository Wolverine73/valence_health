...
%macro vmine_pgf_combine_temp(datapgf=,datavm=);
   ...
   *SASDOC--------------------------------------------------------------------------
   ...
   +------------------------------------------------------------------------SASDOC*;
	...
	proc sort data=all1 out= work.&allclaims_dataset(compress=yes);
   ...
   *SASDOC--------------------------------------------------------------------------
   ...
   +------------------------------------------------------------------------SASDOC*;
	data work.allclaims_&clientname.;
		set work.&allclaims_dataset;
	run;

%mend vmine_pgf_combine_temp;
